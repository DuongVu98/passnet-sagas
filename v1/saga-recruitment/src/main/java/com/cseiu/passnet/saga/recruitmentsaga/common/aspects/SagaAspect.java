package com.cseiu.passnet.saga.recruitmentsaga.common.aspects;
...
public class SagaAspect {
    ...
    @Pointcut("@annotation(com.cseiu.passnet.saga.recruitmentsaga.common.annotations.CleanupSaga)")
