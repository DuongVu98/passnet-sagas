...
public final class CompensatingExecutorGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.cseiu.passnet.saga.classroomsaga.ConsumeEvents.EventIdProtobuf,
      com.cseiu.passnet.saga.classroomsaga.ConsumeEvents.ServiceResponseProtobuf> getRollbackMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Rollback",
      requestType = com.cseiu.passnet.saga.classroomsaga.ConsumeEvents.EventIdProtobuf.class,
      responseType = com.cseiu.passnet.saga.classroomsaga.ConsumeEvents.ServiceResponseProtobuf.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.cseiu.passnet.saga.classroomsaga.ConsumeEvents.EventIdProtobuf,
      com.cseiu.passnet.saga.classroomsaga.ConsumeEvents.ServiceResponseProtobuf> getRollbackMethod() {
    io.grpc.MethodDescriptor<com.cseiu.passnet.saga.classroomsaga.ConsumeEvents.EventIdProtobuf, com.cseiu.passnet.saga.classroomsaga.ConsumeEvents.ServiceResponseProtobuf> getRollbackMethod;
      ...
      synchronized (CompensatingExecutorGrpc.class) {
        if ((getRollbackMethod = CompensatingExecutorGrpc.getRollbackMethod) == null) {
          CompensatingExecutorGrpc.getRollbackMethod = getRollbackMethod = 
              io.grpc.MethodDescriptor.<com.cseiu.passnet.saga.classroomsaga.ConsumeEvents.EventIdProtobuf, com.cseiu.passnet.saga.classroomsaga.ConsumeEvents.ServiceResponseProtobuf>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "consumeEvents.CompensatingExecutor", "Rollback"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.cseiu.passnet.saga.classroomsaga.ConsumeEvents.EventIdProtobuf.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.cseiu.passnet.saga.classroomsaga.ConsumeEvents.ServiceResponseProtobuf.getDefaultInstance()))
  ...
  public static abstract class CompensatingExecutorImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void rollback(com.cseiu.passnet.saga.classroomsaga.ConsumeEvents.EventIdProtobuf request,
        io.grpc.stub.StreamObserver<com.cseiu.passnet.saga.classroomsaga.ConsumeEvents.ServiceResponseProtobuf> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.cseiu.passnet.saga.classroomsaga.ConsumeEvents.EventIdProtobuf,
                com.cseiu.passnet.saga.classroomsaga.ConsumeEvents.ServiceResponseProtobuf>(
  ...
  public static final class CompensatingExecutorBlockingStub extends io.grpc.stub.AbstractStub<CompensatingExecutorBlockingStub> {
    ...
    /**
     */
    public com.cseiu.passnet.saga.classroomsaga.ConsumeEvents.ServiceResponseProtobuf rollback(com.cseiu.passnet.saga.classroomsaga.ConsumeEvents.EventIdProtobuf request) {
  ...
  public static final class CompensatingExecutorFutureStub extends io.grpc.stub.AbstractStub<CompensatingExecutorFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.cseiu.passnet.saga.classroomsaga.ConsumeEvents.ServiceResponseProtobuf> rollback(
        com.cseiu.passnet.saga.classroomsaga.ConsumeEvents.EventIdProtobuf request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_ROLLBACK:
          serviceImpl.rollback((com.cseiu.passnet.saga.classroomsaga.ConsumeEvents.EventIdProtobuf) request,
              (io.grpc.stub.StreamObserver<com.cseiu.passnet.saga.classroomsaga.ConsumeEvents.ServiceResponseProtobuf>) responseObserver);
          break;
        default:
