package com.cseiu.passnet.sagaprofile.flow.consume.core.handler;
...
import com.cseiu.passnet.sagaprofile.common.models.DomainServiceNames;
...
public class ServiceResponseHandler {
    ...
    private static String SERVICE_NAME = DomainServiceNames.PROFILE_SERVICE.name();
